               ...
               <div class="row">
                  ...
                  <div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-7">
                     <div class="card__content">
                        ...
                        <ul class="card__meta">
                           <li><span>Thể loại:</span> <a href="#">Action</a>
                              <a href="#">Triler</a>
                           </li>
                           <li><span>Năm phát hành:</span> 2017</li>
                           <li><span>Thời gian:</span> 120 min</li>
                        ...
                        <div class="comments">
                           <ul class="comments__list">
                              <li class="comments__item">
                                 ...
                                 <p class="comments__text">Phim cũng hay.</p>
                              ...
                              <li class="comments__item comments__item--answer">
                                 ...
                                 <p class="comments__text">Không hay mấy.</p>
                                 <div class="comments__actions">
                                    <div class="comments__rate">
                              ...
                              <li class="comments__item comments__item--quote">
                                 ...
                                 <p class="comments__text"><span>Phim rất hay</p>
                                 <div class="comments__actions">
                                    <div class="comments__rate">
                        ...
                        <div class="reviews">
                           <ul class="reviews__list">
                              <li class="reviews__item">
                                 ...
                                 <p class="reviews__text">Phim hay 10 điểm.</p>
                              </li>
                           </ul>
                           <form action="#" class="form">
                              <input type="text" class="form__input" placeholder="Tiêu đề">
                              <textarea class="form__textarea" placeholder="Để lại đánh giá"></textarea>
